    ...
    return {
        ...
        getForm: function () {
            var frm = new Ext.form.FormPanel({
                url: appPath + '/site/changeOrder.do',
                labelAlign: 'left',
                buttonAlign: 'center',
                            ...
                            if (this.frm.form.isValid()) {
                                this.frm.form.submit({
                                    success: function (form, action) {
                                        ...
                                        form.reset();
                                        App.siteList.store.reload();
                                        App.siteList.dlg.hide();
                                    },
        ...
        createGrid: function (id) {
            ...
            function optRender(value, p, record) {
                ...
                var st    = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" src="' + appPath + '/scripts/icons/page_go.png" title="发布" onclick="App.siteList.status_up(' + value + ')"/>';
                return String.format('<input type="image" src="' + appPath + '/scripts/icons/page_edit.png" title="编辑" onclick="App.siteList.edit(' + value + ')"/>' );
            }
        ...
        edit: function () {
            if (App.siteList.grid.getSelectionModel().hasSelection()) {
                App.siteList.dlg.setTitle("编辑");
                var rec = App.siteList.grid.getSelectionModel().getSelected();
                Ext.apply(App.siteList.currentFormValues, {
                    id: rec.data.id,
                    name: rec.data.name,
                    url: rec.data.url,
                    orderId: rec.data.orderId
                });
                App.siteList.dlg.show();
            } else {

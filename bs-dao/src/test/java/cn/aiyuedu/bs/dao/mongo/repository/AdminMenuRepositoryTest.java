 ...
 */
//@Ignore
public class AdminMenuRepositoryTest extends BaseTest {

    private final Logger logger = LoggerFactory.getLogger(AdminMenuRepositoryTest.class);
...
//    private MenuDao menuDao;
    ...
    public void dataMigrationTest(){
        //从MySql中获取所有信息
//        List<Menu> list = menuDao.find(null);
        ...
        if(CollectionUtils.isNotEmpty(list)){
            ...
            //mongodb中对应集合的名称
            String collectionName = mongoOperations.getCollectionName(Menu.class);
